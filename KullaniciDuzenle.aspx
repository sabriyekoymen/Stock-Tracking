<%@ Page Title="" Language="C#" MasterPageFile="MainMaster.Master" AutoEventWireup="true" CodeBehind="KullaniciDuzenle.aspx.cs" Inherits="stoktakip2.KullaniciDuzenle" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    <div class="row">
        <div class="col-lg-12">
            <h3 class="page-header">Kullanıcı Düzenle</h3>
        </div>
        <!-- /.col-lg-12 -->
    </div>
                ...
                <div style="max-width: 400px;">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <%-- <label for="txttip">
                                Tip</label>
                            <asp:TextBox ID="txttip" runat="server" CssClass="form-control" 
                                />
                            <br />--%>
...
<%--<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="KullaniciDuzenle.aspx.cs" Inherits="stoktakip2.KullaniciDuzenle" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <p>
            ...
            <asp:Button ID="btndegistir" runat="server" Text="Değiştir" OnClick="btndegistir_Click" />
        </p>
